...
_LAZY_IMPORTS = {
    ...
    "_normalize_variable_path": (
        "server_execution.variable_resolution",
        "_normalize_variable_path",
    ),
    ...
    "MissingParameterError": (
        "server_execution.function_analysis",
        "MissingParameterError",
    ),
    ...
    # Language detection
    "detect_server_language": (
        "server_execution.language_detection",
        "detect_server_language",
    ),
    # Request parsing
    ...
    "_extract_context_dicts": (
        "server_execution.request_parsing",
        "_extract_context_dicts",
    ),
    "_collect_parameter_sources": (
        "server_execution.request_parsing",
        "_collect_parameter_sources",
    ),
    ...
    "_handle_successful_execution": (
        "server_execution.response_handling",
        "_handle_successful_execution",
    ),
    # Error handling
    "_render_execution_error_html": (
        "server_execution.error_handling",
        "_render_execution_error_html",
    ),
    ...
    "_build_function_invocation_snippet": (
        "server_execution.code_execution",
        "_build_function_invocation_snippet",
    ),

#!/bin/bash
# python server - Run Python (often for data/text processing)
# Usage: /python/[ARGS][/input-source]
# - ARGS: optional arguments for the python command (use '_' to skip while piping)

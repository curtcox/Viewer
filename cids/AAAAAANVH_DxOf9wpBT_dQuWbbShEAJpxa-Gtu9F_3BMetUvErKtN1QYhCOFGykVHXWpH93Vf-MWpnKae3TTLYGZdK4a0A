#!/bin/bash
# systemctl server - Query/control services (often queried in one-liners)
# Usage: /systemctl/[ARGS][/input-source]
# - ARGS: optional arguments for the systemctl command (use '_' to skip while piping)

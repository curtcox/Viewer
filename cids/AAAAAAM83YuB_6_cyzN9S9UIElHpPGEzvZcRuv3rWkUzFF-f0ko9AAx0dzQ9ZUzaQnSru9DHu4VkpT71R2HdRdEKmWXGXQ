#!/bin/bash
# mktemp server - Create temp file/dir and print its name
# Usage: /mktemp/[ARGS][/input-source]
# - ARGS: optional arguments for the mktemp command (use '_' to skip while piping)

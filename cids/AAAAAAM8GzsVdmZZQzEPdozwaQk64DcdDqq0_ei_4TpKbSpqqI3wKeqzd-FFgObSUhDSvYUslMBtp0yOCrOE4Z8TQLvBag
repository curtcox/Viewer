#!/bin/bash
# netstat server - Network connections/routes (legacy)
# Usage: /netstat/[ARGS][/input-source]
# - ARGS: optional arguments for the netstat command (use '_' to skip while piping)

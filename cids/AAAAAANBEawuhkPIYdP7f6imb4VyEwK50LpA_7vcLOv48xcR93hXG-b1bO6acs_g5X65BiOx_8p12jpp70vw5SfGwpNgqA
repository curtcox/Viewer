#!/bin/bash
# readlink server - Print symlink target / resolve paths
# Usage: /readlink/[ARGS][/input-source]
# - ARGS: optional arguments for the readlink command (use '_' to skip while piping)

#!/bin/bash
# basename server - Strip directory/suffix from a path
# Usage: /basename/[ARGS][/input-source]
# - ARGS: optional arguments for the basename command (use '_' to skip while piping)

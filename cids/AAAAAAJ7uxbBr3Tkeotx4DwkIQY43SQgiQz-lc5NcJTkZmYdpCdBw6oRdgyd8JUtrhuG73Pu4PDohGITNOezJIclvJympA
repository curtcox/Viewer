#!/bin/bash
# printenv server - Print environment variables
# Usage: /printenv/[ARGS][/input-source]
# - ARGS: optional arguments for the printenv command (use '_' to skip while piping)

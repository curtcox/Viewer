#!/bin/bash
# kubectl server - Kubernetes CLI (query or mutate cluster)
# Usage: /kubectl/[ARGS][/input-source]
# - ARGS: optional arguments for the kubectl command (use '_' to skip while piping)

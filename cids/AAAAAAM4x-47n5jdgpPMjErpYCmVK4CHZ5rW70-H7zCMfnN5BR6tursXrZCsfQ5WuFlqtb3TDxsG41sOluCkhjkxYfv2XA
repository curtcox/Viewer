#!/bin/bash
# xargs server - Build/execute commands from stdin items
# Usage: /xargs/[ARGS][/input-source]
# - ARGS: optional arguments for the xargs command (use '_' to skip while piping)

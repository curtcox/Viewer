#!/bin/bash
# timeout server - Run a command with a time limit
# Usage: /timeout/[ARGS][/input-source]
# - ARGS: optional arguments for the timeout command (use '_' to skip while piping)

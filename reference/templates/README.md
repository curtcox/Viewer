...
```json
{
  ...
  "aliases": [
    {
      "name": "ai",
      "definition_cid": "reference/templates/aliases/ai.txt",
      "enabled": true
    },
    {
      "name": "ai_about",
      "definition_cid": "reference/templates/aliases/ai_about.txt",
      "enabled": true
    }
  ],
  "servers": [
    {
      "name": "ai_stub",
      "definition_cid": "reference/templates/servers/definitions/ai_stub.py",
      "enabled": true
    }
  ],
  "variables": [
...
```json
{
  ...
  "servers": {
    "echo": {
      ...
      "definition_cid": "reference/templates/servers/definitions/echo.py"
    }
  },
  "variables": {
    "example-variable": {
      ...
      "definition_cid": "reference/templates/variables/example_var.txt"
    }
  },
  "secrets": {},
  "uploads": {
    "hello-world": {
      ...
      "content_cid": "reference/templates/uploads/contents/hello_world.html"
    }
  }
}
```
...
2. Add an entry to `templates.source.json`:
   ...
   "aliases": {
     "my-alias": {
       ...
       "definition_cid": "reference/templates/aliases/myalias.txt"
     }
   }
   ```
...
2. Add an entry to `templates.source.json`:
   ...
   "servers": {
     "my-server": {
       ...
       "definition_cid": "reference/templates/servers/definitions/myserver.py"
     }
   }
   ```
...
2. Add an entry to `templates.source.json`:
   ...
   "variables": {
     "my-variable": {
       ...
       "definition_cid": "reference/templates/variables/myvar.txt"
     }
   }
   ```

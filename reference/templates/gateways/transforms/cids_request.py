...
"""Request transform for CIDS archive gateway.

Transforms incoming gateway requests for the cids server.
The gateway automatically routes to /servers/cids.
Path format: /gateway/cids/{CID}/{file_path}
"""
...
def transform_request(request_details: dict, context: dict) -> dict:
    """Transform request for CIDS server.

...
COMMON_COMMANDS: List[CommandInfo] = [
    ...
    _command("ls", "List directory contents", "Source"),
    ...
    _command("shasum", "Hash/check SHA digests", "Transform"),
    ...
    _command("tree", "Display a directory tree", "Source"),
    ...
    _command("which", "Locate a command in PATH", "Source"),

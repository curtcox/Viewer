#!/bin/bash
# ifconfig server - Show/configure interfaces (legacy)
# Usage: /ifconfig/[ARGS][/input-source]
# - ARGS: optional arguments for the ifconfig command (use '_' to skip while piping)

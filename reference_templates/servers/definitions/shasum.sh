#!/bin/bash
# shasum server - Hash/check SHA digests (macOS-friendly)
# Usage: /shasum/[ARGS][/input-source]
# - ARGS: optional arguments for the shasum command (use '_' to skip while piping)

#!/bin/bash
# journalctl server - Query systemd journal logs
# Usage: /journalctl/[ARGS][/input-source]
# - ARGS: optional arguments for the journalctl command (use '_' to skip while piping)

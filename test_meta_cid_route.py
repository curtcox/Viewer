...
class TestMetaCIDRoute(unittest.TestCase):
    ...
    def test_meta_route_returns_valid_json_for_existing_cid(self):
        ...
        with self.app.app_context():
            ...
            self._create_test_cid("bafybei123valid", test_content, test_user)
    ...
    def test_meta_route_handles_cid_with_deleted_user(self):
        ...
        with self.app.app_context():
            ...
            test_user = self._create_test_user()
            self._create_test_cid("bafybei123deleted", b"content from deleted user", test_user)
    ...
    def test_meta_route_returns_iso_formatted_datetime(self):
        ...
        with self.app.app_context():
            # Create test CID
            self._create_test_cid("bafybei123datetime", b"datetime test content")
    ...
    def test_meta_route_handles_large_file_size(self):
        ...
        with self.app.app_context():
            ...
            self._create_test_cid("bafybei123large", large_content)
    ...
    def test_meta_route_handles_empty_file(self):
        ...
        with self.app.app_context():
            ...
            empty_content = b""
            self._create_test_cid("bafybei123empty", empty_content)
    ...
    def test_meta_route_handles_special_characters_in_cid(self):
        ...
        with self.app.app_context():
            ...
            self._create_test_cid(special_cid, b"special char content")
    ...
    def test_meta_route_json_response_structure(self):
        ...
        with self.app.app_context():
            ...
            test_user = self._create_test_user()
            self._create_test_cid("bafybei123structure", b"structure test", test_user)
    ...
    def test_meta_route_no_authentication_required(self):
        ...
        with self.app.app_context():
            ...
            self._create_test_cid("bafybei123public", b"public content")

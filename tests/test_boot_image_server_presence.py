...
NON_COMMAND_SERVER_DEFINITIONS = {
    ...
    "cost_estimate": "cost_estimate.py",
    "basecamp": "basecamp.py",
    "calendly": "calendly.py",
    "clickup": "clickup.py",
    "close_crm": "close_crm.py",
    ...
    "google_analytics": "google_analytics.py",
    "google_calendar": "google_calendar.py",
    "google_contacts": "google_contacts.py",
    "google_docs": "google_docs.py",
    "google_drive": "google_drive.py",
    "google_forms": "google_forms.py",
    "github": "github.py",
    "gitlab": "gitlab.py",
    "miro": "miro.py",
    "figma": "figma.py",
    "helpscout": "helpscout.py",
    "hubspot": "hubspot.py",
    "insightly": "insightly.py",
    ...
    "jotform": "jotform.py",
    "klaviyo": "klaviyo.py",
    "linkedin_ads": "linkedin_ads.py",
    "mailchimp": "mailchimp.py",
    "activecampaign": "activecampaign.py",
    "mailerlite": "mailerlite.py",
    "sendgrid": "sendgrid.py",
    "mailgun": "mailgun.py",
    "postmark": "postmark.py",
    "meta_ads": "meta_ads.py",
    "microsoft_excel": "microsoft_excel.py",
    "microsoft_outlook": "microsoft_outlook.py",
    "microsoft_teams": "microsoft_teams.py",
    "monday": "monday.py",
    ...
    "dynamics365": "dynamics365.py",
    "ebay": "ebay.py",
    "etsy": "etsy.py",
    "paypal": "paypal.py",
    "shopify": "shopify.py",
    "squarespace": "squarespace.py",
    "webflow": "webflow.py",
    "wix": "wix.py",
    "woocommerce": "woocommerce.py",

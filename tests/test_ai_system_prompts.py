...
class TestSystemPromptLookup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._get_system_prompt_from_cid = self.ai_assist_module[
            "_get_system_prompt_from_cid"
        ]
    ...
    def test_lookup_with_no_prompts_config(self):
        ...
        context = {"request": {"path": "/servers/test"}}
    ...
    def test_lookup_with_no_request_path(self):
        ...
        prompts_json = json.dumps({"default": "DEFAULT_CID", "/servers": "SERVER_CID"})
    ...
    def test_prefix_matching(self):
        ...
        context = {"request": {"path": "/servers/myserver"}}
...
class TestAiAssistWithSystemPrompts(unittest.TestCase):
    ...
    def test_ai_assist_uses_variable_for_system_prompt(self):
        ...
        prompts_json = json.dumps(
            {"default": "AAAAAA_test_default", "/servers": "AAAAAA_test_server"}
        )

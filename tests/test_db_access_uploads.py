...
class TestDbAccessUploads(unittest.TestCase):
    ...
    def test_get_template_uploads_with_templates(self):
        ...
        templates_config = {
            ...
            "uploads": {
                ...
                "json_sample": {"name": "JSON Sample", "content": '{"key": "value"}'},
            },
        }
    ...
    def test_get_template_uploads_sorted_by_name(self):
        ...
        templates_config = {
            ...
            "secrets": {},
            "uploads": {
                "zebra": {"name": "Zebra Template", "content": "zzz"},
                "alpha": {"name": "Alpha Template", "content": "aaa"},
                "beta": {"name": "Beta Template", "content": "bbb"},
            },
        }

...
def test_add_email_field(memory_client, requires_openrouter_api_key, ai_interaction_tracker):
    ...
    for user in parsed['users']:
        assert 'email' in user, f"User {user.get('name', 'unknown')} missing email field"

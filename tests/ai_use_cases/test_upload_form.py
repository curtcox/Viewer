...
def test_convert_to_markdown_list(memory_client, requires_openrouter_api_key, ai_interaction_tracker):
...
Secure'''
    ...
    assert 'easy' in updated_lower and 'use' in updated_lower, \
        "Missing 'Easy to Use'"

...
class TestCrudFactoryRoutes(unittest.TestCase):
    ...
    def test_delete_route_deletes_entity_and_flashes_message(
        self, mock_flash, mock_delete
    ):
...
class TestCrudFactoryNewEditRoutes(unittest.TestCase):
    ...
    def test_register_standard_crud_routes_registers_new_edit_if_template(
        self, mock_edit, mock_new
    ):
    ...
    @patch("routes.crud_factory.create_new_route")
    @patch("routes.crud_factory.create_edit_route")
    def test_register_standard_crud_routes_skips_new_edit_if_no_template(
        self, mock_edit, mock_new
    ):

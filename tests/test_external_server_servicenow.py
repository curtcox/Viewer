...
def test_invalid_operation():
    assert servicenow.main(instance="dev", SERVICENOW_USERNAME="user", SERVICENOW_PASSWORD="pass", operation="unknown")["output"]["error"]["message"] == "Unsupported operation"


def test_get_record_requires_id():
    assert servicenow.main(instance="dev", SERVICENOW_USERNAME="user", SERVICENOW_PASSWORD="pass", operation="get_record")["output"]["error"]["message"] == "Missing required sys_id"


def test_update_record_requires_id():
    assert servicenow.main(instance="dev", SERVICENOW_USERNAME="user", SERVICENOW_PASSWORD="pass", operation="update_record")["output"]["error"]["message"] == "Missing required sys_id"


def test_create_record_requires_description():
    assert servicenow.main(instance="dev", SERVICENOW_USERNAME="user", SERVICENOW_PASSWORD="pass", operation="create_record", short_description="")["output"]["error"]["message"] == "Missing required short_description"

...
class TestEnabledFieldPersistence(unittest.TestCase):
    ...
    def test_alias_enabled_false_persists(self):
        ...
        alias = Alias(name="test_alias", definition="test definition", enabled=False)
    ...
    def test_alias_enabled_true_persists(self):
        ...
        alias = Alias(name="test_alias", definition="test definition", enabled=True)
        db.session.add(alias)
        db.session.commit()
    ...
    def test_alias_enabled_default_is_true(self):
        ...
        alias = Alias(name="test_alias", definition="test definition")
        db.session.add(alias)
        db.session.commit()
    ...
    def test_server_enabled_false_persists(self):
        ...
        server = Server(name="test_server", definition="test definition", enabled=False)
    ...
    def test_server_enabled_true_persists(self):
        ...
        server = Server(name="test_server", definition="test definition", enabled=True)
        db.session.add(server)
        db.session.commit()
    ...
    def test_server_enabled_default_is_true(self):
        ...
        server = Server(name="test_server", definition="test definition")
        db.session.add(server)
        db.session.commit()
    ...
    def test_variable_enabled_false_persists(self):
        ...
        variable = Variable(
            name="test_variable", definition="test definition", enabled=False
        )
    ...
    def test_variable_enabled_true_persists(self):
        ...
        variable = Variable(
            name="test_variable", definition="test definition", enabled=True
        )
        db.session.add(variable)
        db.session.commit()
    ...
    def test_variable_enabled_default_is_true(self):
        ...
        variable = Variable(name="test_variable", definition="test definition")
        db.session.add(variable)
        db.session.commit()
    ...
    def test_secret_enabled_false_persists(self):
        ...
        secret = Secret(name="test_secret", definition="test definition", enabled=False)
    ...
    def test_secret_enabled_true_persists(self):
        ...
        secret = Secret(name="test_secret", definition="test definition", enabled=True)
        db.session.add(secret)
        db.session.commit()
    ...
    def test_secret_enabled_default_is_true(self):
        ...
        secret = Secret(name="test_secret", definition="test definition")
        db.session.add(secret)
        db.session.commit()

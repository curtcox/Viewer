...
class TestNonServerRunOptions(CliTestCase):
    ...
    def test_list_without_cids_exits_without_server(self):
        ...
        if "Found" in result.stdout:
            self.skipTest(
                "Boot CIDs present in database - cannot test 'not found' case"
            )
    ...
    def test_help_completes_quickly(self):
        ...
        self.assertLess(elapsed, 3.0, f"--help took {elapsed:.2f}s (should be < 3s)")
    ...
    def test_help_short_completes_quickly(self):
        ...
        # Should complete in < 3 seconds
        self.assertLess(elapsed, 3.0, f"-h took {elapsed:.2f}s (should be < 3s)")
    ...
    def test_list_completes_quickly(self):
        ...
        # Should complete in < 3 seconds
        self.assertLess(elapsed, 3.0, f"--list took {elapsed:.2f}s (should be < 3s)")
    ...
    def test_url_completes_quickly(self):
        ...
        # Should complete in < 3 seconds
        self.assertLess(elapsed, 3.0, f"URL / took {elapsed:.2f}s (should be < 3s)")

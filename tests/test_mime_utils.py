...
class TestGetMimeTypeFromExtension(unittest.TestCase):
    ...
    def test_path_with_directories(self):
        ...
        self.assertEqual(
            get_mime_type_from_extension('/path/to/file.txt'),
            'text/plain'
        )
    ...
    def test_unknown_extension(self):
        ...
        self.assertEqual(
            get_mime_type_from_extension('file.unknown'),
    ...
    def test_no_extension(self):
        ...
        self.assertEqual(
            get_mime_type_from_extension('filename'),
            'application/octet-stream'
        )
...
class TestGetExtensionFromMimeType(unittest.TestCase):
    ...
    def test_mime_with_parameters(self):
        ...
        self.assertEqual(
            get_extension_from_mime_type('text/plain; charset=utf-8'),
            'txt'
        )
        self.assertEqual(
